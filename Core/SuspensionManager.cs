...
namespace Nyantilities.Core
{
    ...
    public sealed class SuspensionManager
    {
        ...
        /// completes.</returns>
        public static async Task<bool> RestoreAsync(String sessionBaseKey = null)
        {
            ...
            {
                DebugHelper.WriteLine<SuspensionManager>(e.Message);
            }
        ...
        /// navigation cache.
        /// </summary>
        /// <remarks>Apps may choose to rely on <see cref="NyavigationHelper"/> to manage
