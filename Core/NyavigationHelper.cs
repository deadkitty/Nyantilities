...
namespace Nyantilities.Core
{
    ...
    public class NyavigationHelper : DependencyObject
    {
        private Page Page { get; set; }
        private Frame Frame { get { return Page.Frame; } }

        /// <summary>
        /// Initializes a new instance of the <see cref="NyavigationHelper"/> class.
        /// </summary>
        /// <param name="page">A reference to the current page used for navigation.
        /// This reference allows for frame manipulation.</param>
        public NyavigationHelper(Page page)
        {
            Page = page;
        }
        ...
        /// <summary>
        /// Nyavigates to a new Page where <typeparamref name="T"/> is the Type of the new Page.
        /// </summary>
        /// <typeparam name="T">Type of the new Page. has to be derived from <see cref="NyaPage"/>.</typeparam>
        /// <param name="parameter">Optional.</param>
        public static void NyavigateTo<T>(object parameter = null) where T : NyaPage
        {
            (Window.Current.Content as Frame).Navigate(typeof(T), parameter);
        }
    ...
    /// <summary>
    /// Represents the method that will handle the <see cref="NyavigationHelper.LoadState"/>event
    /// </summary>
    public delegate void LoadStateEventHandler(object sender, LoadStateEventArgs e);
    /// <summary>
    /// Represents the method that will handle the <see cref="NyavigationHelper.SaveState"/>event
    /// </summary>
